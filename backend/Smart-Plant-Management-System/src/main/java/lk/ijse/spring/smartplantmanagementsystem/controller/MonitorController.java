...
import lk.ijse.spring.smartplantmanagementsystem.dto.PlantDiseaseDTO;
...
public class MonitorController {
    ...
    @PostMapping("/{id}/check-disease")
    public PlantDiseaseDTO checkDisease(@PathVariable Long id) throws IOException {
        return monitorService.checkForDisease(id);
    }
}
